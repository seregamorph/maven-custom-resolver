...
/**
 * Full copy of org.eclipse.aether.transport.wagon.WagonTransporter (final, that's why not extended) from
 * "org.apache.maven.resolver:maven-resolver-transport-wagon:1.6.3" with minor changes:
 * <ul>
 * </ul>
 */
final class FailSafeWagonTransporter implements Transporter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FailSafeWagonTransporter.class);
